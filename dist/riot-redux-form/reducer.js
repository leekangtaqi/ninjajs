	...
	switch (action.type) {
		...
		case 'form/input':
			var _action$payload = action.payload,
			    _form = _action$payload.form,
			    input = _action$payload.input;

			formName = _form.$name;
			forms[formName][input.name] = input.value;
			return Object.assign({}, forms, _defineProperty({}, _form.$name, _form));

		case 'form/add':

			_form = action.payload;
			return Object.assign({}, forms, _defineProperty({}, _form.$name, _form));
		...
		case 'forms/inputs/add':
			...
			return Object.assign({}, forms, _extends({}, formsMap));

		case 'forms/remove':

			return Object.assign({}, _util2.default.omit(forms, action.payload.map(function (f) {
				return f.form;
			})));
		...
		case 'form/submit':
			...
			return Object.assign({}, forms, _defineProperty({}, formName, _extends({}, forms[formName], { $submitted: true })));

		case 'form/valid':
			formName = action.payload;

			return Object.assign({}, forms, _defineProperty({}, formName, _extends({}, forms[formName], { $invalid: false, $valid: true })));

		case 'form/unsubmit':
			formName = action.payload;

			return Object.assign({}, forms, _defineProperty({}, formName, _extends({}, forms[formName], { $submitted: false })));
